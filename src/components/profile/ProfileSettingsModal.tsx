	...
	const getDeleteModalContent = () => {
		...
		const content = {
			...
			records: {
				...
				message: t('Are you sure you want to clear all your records and logs? This will remove action log history, notifications, and record data.'),
				items: [
					t('Git action history'),
					t('Other logs and notifications')
				]
			},
			all: {
				title: t('Clear All Local Storage'),
				message: t('Are you sure you want to clear ALL local storage data? This will remove settings, properties, secrets, records, and logs permanently.'),
				items: [
					...
					<div className="local-storage-actions">
						...
						<div className="storage-action-group danger-zone">
							<div className="storage-action-info">
								...
								<p>{t('All settings, properties, secrets, records, and logs at once')}</p>
							</div>
							<div className="storage-action-buttons">
								<button
									type="button"
